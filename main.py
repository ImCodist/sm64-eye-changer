...
class MyFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.statusbar.SetStatusText("v" + option.APP_VERSION)
    ...
    def OnAbout(self, e):
        ...
        aboutInfo.SetVersion(option.APP_VERSION)
...
class Options(wx.Frame):
    def __init__(self, parent):
        ...
        self.textureOpenPath = wx.TextCtrl(tab2, pos=(135, 12), size=(180,22), value=option.TEXTUREPATH1)

        textureMidLabel = wx.StaticText(tab2, label="Texture Eye Mid Path", pos=(10,45))
        self.textureMidPath = wx.TextCtrl(tab2, pos=(135, 42), size=(180,22), value=option.TEXTUREPATH2)

        textureClosedLabel = wx.StaticText(tab2, label="Texture Eye Close Path", pos=(10,75))
        self.textureClosedPath = wx.TextCtrl(tab2, pos=(135, 72), size=(180,22), value=option.TEXTUREPATH3)
